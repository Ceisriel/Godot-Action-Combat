...
var weapon1: PackedScene = preload("res://Weapons/RepeatingCrossbow/RepeatingCrossbow.tscn")
var weapon2: PackedScene = preload("res://Weapons/Spear/Spear.tscn")
var weapon3: PackedScene = preload("res://Weapons/Sword/Sword.tscn")
